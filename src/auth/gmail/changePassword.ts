...
export async function ChangePassword({ email, randomString, firstName, userId }: ForgotPasswordAccountInfo) {
	try {
      ...
      <button><a href='http://localhost:8100/auth/changepassword/${userId}/${randomString}' target='blank'>Reset your password<a/></button>
      </body>`,
		}
